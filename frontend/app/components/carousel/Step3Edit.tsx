...
const SI = {
  ...
  notion: 'M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm-.753 2.835l-.28 12.827c0 .28.14.42.42.42h1.865c.28 0 .42-.14.42-.42l-.28-12.827c0-.28-.14-.42-.42-.42h-1.865c-.28 0-.42.14-.42.42zm9.588-.607l-9.121.56c-.28 0-.42.14-.42.42v12.734c0 .28.14.42.42.42l9.121-.56c.28 0 .42-.14.42-.42V6.856c0-.28-.14-.42-.42-.42z',
  n8n: 'M21.4737 5.6842c-1.1772 0-2.1663.8051-2.4468 1.8947h-2.8955c-1.235 0-2.289.893-2.492 2.111l-.1038.623a1.263 1.263 0 0 1-1.246 1.0555H11.289c-.2805-1.0896-1.2696-1.8947-2.4468-1.8947s-2.1663.8051-2.4467 1.8947H4.973c-.2805-1.0896-1.2696-1.8947-2.4468-1.8947C1.1311 9.4737 0 10.6047 0 12s1.131 2.5263 2.5263 2.5263c1.1772 0 2.1663-.8051 2.4468-1.8947h1.4223c.2805 1.0896 1.2696 1.8947 2.4467 1.8947s2.1663-.8051 2.4468-1.8947H12.29a1.263 1.263 0 0 1 1.246 1.0555l.1038.623c.203 1.218 1.257 2.111 2.492 2.111h2.8955c.2805 1.0896 1.2696 1.8947 2.4468 1.8947C22.8689 18.3158 24 17.1848 24 15.7895s-1.131-2.5263-2.5263-2.5263c-1.1772 0-2.1663.8051-2.4468 1.8947H16.23c-.534 0-.998-.3665-1.14-.882l-.1041-.6225a3.789 3.789 0 0 0-.8985-1.7813 3.789 3.789 0 0 0 .8985-1.7812l.104-.6225c.1421-.5156.6061-.882 1.14-.882h2.9029c.2805 1.0896 1.2696 1.8947 2.4468 1.8947C22.8689 10.6316 24 9.5006 24 8.1053c0-1.3953-1.131-2.4211-2.5263-2.4211z',
  hubspot: 'M18.164 7.93V5.084a2.198 2.198 0 001.267-1.978v-.067A2.2 2.2 0 0017.238.845h-.067a2.2 2.2 0 00-2.193 2.193v.067a2.196 2.196 0 001.252 1.973V7.93a6.234 6.234 0 00-2.964 1.328L7.19 4.328a2.43 2.43 0 00.08-.56 2.44 2.44 0 10-2.439 2.438c.28 0 .549-.048.8-.13l6.02 4.83a6.188 6.188 0 000 7.476L9.307 20.07a2.044 2.044 0 00-.6-.094 2.054 2.054 0 102.054 2.054c0-.3-.065-.585-.18-.844l2.293-1.701A6.218 6.218 0 1018.164 7.93zm-1.079 9.468a3.048 3.048 0 110-6.097 3.048 3.048 0 010 6.097z',
  salesforce: 'M10.006 5.415a4.195 4.195 0 013.045-1.306c1.56 0 2.954.9 3.69 2.205.63-.3 1.35-.45 2.1-.45 2.85 0 5.159 2.34 5.159 5.22s-2.31 5.22-5.176 5.22H6.046A3.996 3.996 0 012.05 12.31a3.996 3.996 0 013.421-3.96 3.747 3.747 0 01-.075-.735 3.765 3.765 0 014.61-3.2z',
        ...
        <div className="flex-1">
          ...
          {showPrompt && (
            <div className="mb-3 rounded-xl border border-brand-orange/20 bg-brand-orange/[0.03] p-3 space-y-2">
              <div className="text-[10px] font-bold text-brand-orange uppercase tracking-widest">AI Visual Generator</div>
        ...
        <div className="w-full lg:w-72 space-y-4">
          ...
          {selText && (
            <div className="rounded-xl border border-brand-orange/20 bg-brand-orange/[0.03] p-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div><label className="text-[9px] text-gray-500">Size</label><input type="range" min={16} max={120} value={selText.fontSize} onChange={e => store.updateTextOverlay(slide.id, selectedId!, { fontSize: +e.target.value })} className="w-full accent-orange-500" /></div>
